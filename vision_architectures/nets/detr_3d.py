...
# %% auto 0
__all__ = ['DETRDecoderConfig', 'DETRBBoxMLPConfig', 'DETR3DConfig', 'DETRDecoder', 'DETRBBoxMLP', 'DETR3DModel']
...
class DETR3DModel(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(self, config: DETR3DConfig = {}, checkpointing_level: int = 0, **kwargs):
        """Initialize the DETR3DModel. Activation checkpointing level 4.
    ...
    def _forward(
        ...
        """Forward pass of the DETR3DModel.
    ...
    def bipartite_matching_loss(
        ...
        matched_indices = DETR3DModel._hungarian_matching(
        ...
        for i in range(B):
            ...
            # BBox IOU loss
            bbox_iou_loss = 1 - DETR3DModel._generalized_bbox_iou(pred_bboxes, target_bboxes)
    ...
    def _hungarian_matching(
        ...
        for i in range(B):
            ...
            bbox_iou_cost = 1 - DETR3DModel._generalized_pairwise_bbox_iou(pred_bboxes, target_bboxes)
            # (num_objects, <=num_objects)
    ...
    def _generalized_pairwise_bbox_iou(
        ...
        for i in range(pred_bboxes.shape[0]):
            ...
            for j in range(target_bboxes.shape[0]):
                giou = DETR3DModel._generalized_bbox_iou(pred_bboxes[i : i + 1], target_bboxes[j : j + 1])
