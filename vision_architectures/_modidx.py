  ...
  'syms': { 'vision_architectures.blocks.heads_3d': { 'vision_architectures.blocks.heads_3d.ClassificationHead3D': ( 'blocks/heads_3d.html#classificationhead3d',
            ...
            'vision_architectures.nets.vit_3d': { 'vision_architectures.nets.vit_3d.ViT3DConfig': ( 'nets/vit_3d.html#vit3dconfig',
                                                  ...
                                                  'vision_architectures.nets.vit_3d.ViT3DSimMIM.loss_fn': ( 'nets/vit_3d.html#vit3dsimmim.loss_fn',
                                                                                                            'vision_architectures/nets/vit_3d.py')},
            'vision_architectures.schedulers.noise': { 'vision_architectures.schedulers.noise.GaussianNoiseScheduler': ( 'schedulers/noise.html#gaussiannoisescheduler',
                                                                                                                         'vision_architectures/schedulers/noise.py'),
                                                       'vision_architectures.schedulers.noise.GaussianNoiseScheduler.__init__': ( 'schedulers/noise.html#gaussiannoisescheduler.__init__',
                                                                                                                                  'vision_architectures/schedulers/noise.py'),
                                                       'vision_architectures.schedulers.noise.GaussianNoiseScheduler.add_noise': ( 'schedulers/noise.html#gaussiannoisescheduler.add_noise',
                                                                                                                                   'vision_architectures/schedulers/noise.py'),
                                                       'vision_architectures.schedulers.noise.GaussianNoiseScheduler.remove_noise': ( 'schedulers/noise.html#gaussiannoisescheduler.remove_noise',
                                                                                                                                      'vision_architectures/schedulers/noise.py')},
