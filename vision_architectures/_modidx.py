  ...
  'syms': { 'vision_architectures.blocks.cnn': { 'vision_architectures.blocks.cnn.CNNBlock3D': ( 'blocks/cnn.html#cnnblock3d',
            ...
            'vision_architectures.schedulers.decaying_sine': { 'vision_architectures.schedulers.decaying_sine.DecayingSineLR': ( 'schedulers/decaying_sine.html#decayingsinelr',
                                                               ...
                                                               'vision_architectures.schedulers.decaying_sine.DecayingSineScheduler.get': ( 'schedulers/decaying_sine.html#decayingsinescheduler.get',
                                                                                                                                            'vision_architectures/schedulers/decaying_sine.py'),
                                                               'vision_architectures.schedulers.decaying_sine.DecayingSineScheduler.is_ready': ( 'schedulers/decaying_sine.html#decayingsinescheduler.is_ready',
                                                                                                                                                 'vision_architectures/schedulers/decaying_sine.py'),
                                                               'vision_architectures.schedulers.decaying_sine.DecayingSineScheduler.set_wavelength': ( 'schedulers/decaying_sine.html#decayingsinescheduler.set_wavelength',
                                                                                                                                                       'vision_architectures/schedulers/decaying_sine.py'),
