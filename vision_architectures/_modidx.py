...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'vision_architectures.blocks.cnn': { 'vision_architectures.blocks.cnn.CNNBlock2D': ( 'blocks/cnn.html#cnnblock2d',
                                                 ...
                                                 'vision_architectures.blocks.cnn.TensorSplittingConv.get_split_stride': ( 'blocks/cnn.html#tensorsplittingconv.get_split_stride',
                                                                                                                           'vision_architectures/blocks/cnn.py'),
                                                 'vision_architectures.blocks.cnn.TensorSplittingConv.pad_input': ( 'blocks/cnn.html#tensorsplittingconv.pad_input',
                                                                                                                    'vision_architectures/blocks/cnn.py'),
                                                 ...
                                                 'vision_architectures.blocks.cnn.add_tsp_to_module': ( 'blocks/cnn.html#add_tsp_to_module',
                                                                                                        'vision_architectures/blocks/cnn.py'),
                                                 'vision_architectures.blocks.cnn.remove_tsp_to_module': ( 'blocks/cnn.html#remove_tsp_to_module',
                                                                                                           'vision_architectures/blocks/cnn.py')},
