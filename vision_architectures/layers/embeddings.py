...
# %% auto 0
__all__ = ['RelativePositionEmbeddings', 'get_absolute_timestep_embeddings_1d', 'get_absolute_position_embeddings_1d',
           ...
           'get_absolute_position_embeddings_3d', 'AbsolutePositionEmbeddings3D', 'get_absolute_embeddings_1d',
...
def get_absolute_embeddings_1d(dim: int, length: int) -> torch.Tensor:
    if dim % 2 != 0:
...
get_absolute_timestep_embeddings_1d = get_absolute_embeddings_1d
get_absolute_position_embeddings_1d = get_absolute_embeddings_1d
