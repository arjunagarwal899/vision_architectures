    ...
    def __init__(self, config):
        ...
        if config["use_absolute_position_embeddings"]:
            ...
            if config["learnable_absolute_position_embeddings"]:
                ...
                self.absolute_position_embeddings = get_3d_position_embeddings(
                    dim,
                    grid_size,
                    config["patch_size"],
                )
...
class Swin3DMIM(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor, spacings: torch.Tensor):
        ...
        loss = self.loss(decoded, pixel_values)
        mask = repeat(
            mask_patches,
